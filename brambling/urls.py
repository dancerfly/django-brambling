...
urlpatterns = patterns('',
    ...
    url(r'^(?P<slug>[\w-]+)/finalize/$',
        FinalizeCartView.as_view(),
        name="brambling_event_finalize"),
    url(r'^(?P<slug>[\w-]+)/finalize/forms/$',
        CartFormsView.as_view(),
        name="brambling_event_finalize_forms"),

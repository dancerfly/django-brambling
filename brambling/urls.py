...
urlpatterns = patterns('',
    ...
    url(r'^mail/invite_event_edit/$', InvitePreviewView.as_view(kind=Invite.EVENT_EDIT)),
    url(r'^mail/invite_event_view/$', InvitePreviewView.as_view(kind=Invite.EVENT_VIEW)),
    url(r'^mail/invite_org_edit/$', InvitePreviewView.as_view(kind=Invite.ORGANIZATION_EDIT)),
    url(r'^mail/invite_org_view/$', InvitePreviewView.as_view(kind=Invite.ORGANIZATION_VIEW)),

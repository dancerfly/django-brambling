...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('brambling', '0002_eventhousing_housingslot_itemoption'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ef_present', models.ManyToManyField(to=b'brambling.EnvironmentalFactor', null=True, verbose_name=b'People in my/our home will be exposed to', blank=True)),
                ...
                ('housing_categories', models.ManyToManyField(to=b'brambling.HousingCategory', null=True, verbose_name=b'My/Our home is (a/an)', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home', models.ForeignKey(to_field='id', blank=True, to='brambling.Home', null=True)),
                ...
                ('default_card', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to_field='id', blank=True, to='brambling.CreditCard')),
                ...
                ('dietary_restrictions', models.ManyToManyField(to=b'brambling.DietaryRestriction', null=True, blank=True)),
                ...
                ('event_types', models.ManyToManyField(to=b'brambling.EventType', blank=True)),
            ],
            options={
                'verbose_name': 'person',

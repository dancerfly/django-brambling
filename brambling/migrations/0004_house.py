...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('brambling', '0003_dietaryrestriction_environmentalfactor'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ef_present', models.ManyToManyField(to='brambling.EnvironmentalFactor', blank=True)),

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_per_owner', models.PositiveSmallIntegerField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ef_present', models.ManyToManyField(to=b'brambling.EnvironmentalFactor', null=True, verbose_name=b'People in the home will be exposed to', blank=True)),
                ...
                ('housing_categories', models.ManyToManyField(to=b'brambling.HousingCategory', null=True, verbose_name=b'Our home is (a/an)', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),

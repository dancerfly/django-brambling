    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dance_style', models.ForeignKey(to_field=u'id', blank=True, to='brambling.DanceStyle', null=True)),
                ('event_type', models.ForeignKey(to_field=u'id', blank=True, to='brambling.EventType', null=True)),
                ('privacy', models.CharField(default='public', max_length=7, choices=[('public', u'List publicly'), ('link', u'Visible to anyone with the link'), ('private', u'Only visible to owner and editors')])),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('collect_housing_data', models.BooleanField(default=True)),
                ('reservation_timeout', models.PositiveSmallIntegerField(default=15, help_text='Minutes before reserved items are removed from cart.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=7, choices=[('merch', u'Merchandise'), ('comp', u'Competition'), ('class', u'Class/Lesson a la carte'), ('pass', u'Pass')])),

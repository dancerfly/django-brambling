    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ef_present', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='The house has', blank=True)),
                ('ef_avoid_strong', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='Not allowed in the house', blank=True)),
                ('ef_avoid_weak', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='Preferred not in the house', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wakeup', models.CharField(max_length=5, choices=[('late', u'Get up when you get up'), ('early', u'There first thing.')])),
                ('other', models.TextField(blank=True)),
                ('ef_cause', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='I will cause/have', blank=True)),
                ('ef_avoid_strong', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='Never put me somewhere with', blank=True)),
                ('ef_avoid_weak', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name="I'd rather not be around", blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.ForeignKey(to_field=u'id', blank=True, to='brambling.House', null=True)),
                ...
                ('ef_avoid_strong', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name='Never put me somewhere with', blank=True)),
                ('ef_avoid_weak', models.ManyToManyField(to='brambling.EnvironmentalFactor', null=True, verbose_name="I'd rather not be around", blank=True)),
                ('dance_styles', models.ManyToManyField(to='brambling.DanceStyle')),
                ('event_types', models.ManyToManyField(to='brambling.EventType')),
            ],
            options={

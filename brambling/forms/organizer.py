...
class OrganizationForm(forms.ModelForm):
    ...
    class Meta:
        model = Organization
        fields = (
            'name', 'slug', 'description', 'website_url', 'facebook_url',
            'banner_image', 'city', 'state_or_province', 'country',
            'dance_styles', 'default_event_city',
            'default_event_state_or_province', 'default_event_country',
            'default_event_timezone', 'default_event_currency',
